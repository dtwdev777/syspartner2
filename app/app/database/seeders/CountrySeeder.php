...
class CountrySeeder extends Seeder
{
     ...
     * Заполняет таблицу 'countries' названиями стран и их ISO кодами.
     */
    public function run(): void
    {
        // Список стран мира (ISO 3166-1 Alpha-2 коды и названия).
        $countries = [
            ...
            ['name' => 'Republic of Moldova', 'iso_code' => 'MD'],
            ...
            ['name' => 'United Republic of Tanzania', 'iso_code' => 'TZ'],
            ...
            // Включаем Святой Престол (Ватикан) и Государство Палестина
            ['name' => 'Holy See', 'iso_code' => 'VA'], 
            ['name' => 'Palestine, State of', 'iso_code' => 'PS'],
        ];

        // Вставляем все данные одной операцией.
